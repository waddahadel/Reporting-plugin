...
class ilReportingUsersPerCourseLPReportTableGUI extends ilReportingReportTableGUI {
    ...
    public function exportDataCustom($format, $send = false) {
        switch ($format) {
            case ilReportingGUI::EXPORT_PDF:
                ...
                $export->setReportGroups(array('id' => 'group_course', 'usr_id' => 'group_user'));
    ...
    protected function getAdditionalColumns() {
        return array(
            ...
            'object_percentage' => array('txt' => $this->pl->txt('object_percentage'), 'formatter' => ilReportingFormatter::FORMAT_STR_PERCENTAGE),
            'object_status' => array('txt' => $this->pl->txt('object_status'), 'formatter' => ilReportingFormatter::FORMAT_INT_STATUS),
            'object_type' => array('txt' => $this->pl->txt('object_percentage'), 'formatter' => ilReportingFormatter::FORMAT_STR_OBJECT_TYPE),
            'object_status_changed' => array('txt' => $this->pl->txt('object_status_changed'), 'formatter' => ilReportingFormatter::FORMAT_STR_DATE),
        );
    }
